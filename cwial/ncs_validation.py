...
def reproducibility(scores_by_condition):
    ...
    # NOTE: with the three conditions used in the synthetic example this
    # estimate rests on three draws of the condition-level offset and carries
    # large uncertainty of its own. statistics.pstdev divides by n, so it is
    # also biased low. Characterising a real instrument needs more conditions.
